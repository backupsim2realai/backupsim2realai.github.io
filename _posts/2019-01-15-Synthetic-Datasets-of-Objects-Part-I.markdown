...
- The ABC dataset is not publicly available yet (at the time of writing this post). The majority of the models are mechanical parts and and not typical categories of objects like chairs, tables etc.
