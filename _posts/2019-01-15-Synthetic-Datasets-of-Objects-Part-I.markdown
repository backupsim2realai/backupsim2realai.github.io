...
The image below shows the size of repositories that provide 3D assets and models. It is not surprising to see that large majority of these repositories contain 1M models and we believe the content will continue to grow with time.
