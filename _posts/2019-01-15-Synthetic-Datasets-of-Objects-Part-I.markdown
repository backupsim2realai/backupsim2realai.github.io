...
<img src="/assets/img/2019-01-15/onshape_design.gif" width="50%">
...
- Some 3D models have missing textures or lack material information. For instance, some objects have the path of material information set to the path on the local computer of the designer and this sometimes results in missing texture information. Additionally, the UV-mapping of the vertices tends to be wrong at times resulting in unexpected wrapping of texture on the mesh.
