...
Therefore, it can be written as $$\psi_i = \tau_i + J_i^T F_{c_i} - d_ii\dot q_i$$. Since the potential energy does not depend on the velocity, the euler-lagrange equation can be further simplied as 
